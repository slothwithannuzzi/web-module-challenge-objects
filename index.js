...
reviews.push({name: 'John', rating: 4, feedback: "I liked the music and the drinks were cheap."})
...
function getReviewByIndex(array, index) {
  return `${array[index].name} gave the resturaunt a ${array[index].rating} star review, and their feedback was: ${array[index].feedback}`;
}
